      ...
      >
        <div>
          ...
          <p class="mt-1 text-sm text-gray-500">
            Latest status and updates across devices.
          </p>
        </div>
        <div class="sm:w-72">
          <label class="sr-only" for="device-name-search"
            >Search devices by name</label
          >
          <input
          ...
          >
            ...
            <td class="whitespace-nowrap px-5 py-4">
              <div class="flex items-center gap-3">
                <div
                  class="h-7 w-32 rounded-lg bg-gray-50 ring-1 ring-inset ring-gray-100"
                >
                  <svg
                    viewBox="0 0 120 28"
